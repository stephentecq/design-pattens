   ...
   public static $instance;
    ...
    public function mk_content()
    {
        if( $this->create_status == false)
        {
            ...
            echo "<form name='content' method='post' action='app.php' >";
    ...
    public function get_content()
    {
        ...
        {
           $this->title = $_SESSION['title'] = $_POST['title'];
            $this->content = $_SESSION['content'] = $_POST['content'];
    ...
    {
        echo "<h3>App Name:" .$this->name. "</h3>";
        echo "<h3>App Title:" . $this->title . "</h3>";
        echo "<h3>App content:" . $this->content . "</h3>";
    }
